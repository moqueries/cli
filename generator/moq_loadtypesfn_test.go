...
func (m *moqLoadTypesFn) mock() generator.LoadTypesFn {
...
func (r *moqLoadTypesFn_fnRecorder) times(count int) *moqLoadTypesFn_fnRecorder {
	if r.results == nil {
...
func (r *moqLoadTypesFn_fnRecorder) anyTimes() {
	if r.results == nil {
