...
type moqTypeCache struct {
	...
	resultsByParams_LoadPackage         []moqTypeCache_LoadPackage_resultsByParams
	resultsByParams_MockableTypes       []moqTypeCache_MockableTypes_resultsByParams
...
type moqTypeCache_LoadPackage_results struct {
	...
	results []struct {
		...
		sequence   uint32
		doFn       moqTypeCache_LoadPackage_doFn
		doReturnFn moqTypeCache_LoadPackage_doReturnFn
	}
	index  uint32
...
type moqTypeCache_LoadPackage_fnRecorder struct {
	...
	anyParams uint64
	sequence  bool
	results   *moqTypeCache_LoadPackage_results
	moq       *moqTypeCache
}
...
type moqTypeCache_MockableTypes_results struct {
	...
	results []struct {
		...
		sequence   uint32
		doFn       moqTypeCache_MockableTypes_doFn
		doReturnFn moqTypeCache_MockableTypes_doReturnFn
	}
	index  uint32
	repeat *moq.RepeatVal
}
...
type moqTypeCache_MockableTypes_fnRecorder struct {
	...
	anyParams uint64
	sequence  bool
	results   *moqTypeCache_MockableTypes_results
	moq       *moqTypeCache
}
...
func (m *moqTypeCache_mock) LoadPackage(pkgPattern string) (result1 error) {
	m.moq.scene.T.Helper()
	params := moqTypeCache_LoadPackage_params{
		pkgPattern: pkgPattern,
	}
	var results *moqTypeCache_LoadPackage_results
	for _, resultsByParams := range m.moq.resultsByParams_LoadPackage {
		paramsKey := m.moq.paramsKey_LoadPackage(params, resultsByParams.anyParams)
		var ok bool
	...
	if results == nil {
		if m.moq.config.Expectation == moq.Strict {
			m.moq.scene.T.Fatalf("Unexpected call to %s", m.moq.prettyParams_LoadPackage(params))
		}
		return
	}
	...
	if i >= results.repeat.ResultCount {
		if !results.repeat.AnyTimes {
			if m.moq.config.Expectation == moq.Strict {
				m.moq.scene.T.Fatalf("Too many calls to %s", m.moq.prettyParams_LoadPackage(params))
			}
			return
		}
	...
	if result.sequence != 0 {
		...
		if (!results.repeat.AnyTimes && result.sequence != sequence) || result.sequence > sequence {
			m.moq.scene.T.Fatalf("Call sequence does not match call to %s", m.moq.prettyParams_LoadPackage(params))
		}
	}

	if result.doFn != nil {
		result.doFn(pkgPattern)
	}
	...
	if result.doReturnFn != nil {
		result1 = result.doReturnFn(pkgPattern)
	}
	return
}

func (m *moqTypeCache_mock) MockableTypes(onlyExported bool) (result1 []dst.Ident) {
	m.moq.scene.T.Helper()
	params := moqTypeCache_MockableTypes_params{
		onlyExported: onlyExported,
	}
	var results *moqTypeCache_MockableTypes_results
	for _, resultsByParams := range m.moq.resultsByParams_MockableTypes {
		paramsKey := m.moq.paramsKey_MockableTypes(params, resultsByParams.anyParams)
		var ok bool
		results, ok = resultsByParams.results[paramsKey]
		if ok {
			break
	...
	if results == nil {
		if m.moq.config.Expectation == moq.Strict {
			m.moq.scene.T.Fatalf("Unexpected call to %s", m.moq.prettyParams_MockableTypes(params))
		}
		return
	}
	...
	if i >= results.repeat.ResultCount {
		if !results.repeat.AnyTimes {
			if m.moq.config.Expectation == moq.Strict {
				m.moq.scene.T.Fatalf("Too many calls to %s", m.moq.prettyParams_MockableTypes(params))
			}
			return
		}
		i = results.repeat.ResultCount - 1
	...
	if result.sequence != 0 {
		sequence := m.moq.scene.NextMockSequence()
		if (!results.repeat.AnyTimes && result.sequence != sequence) || result.sequence > sequence {
			m.moq.scene.T.Fatalf("Call sequence does not match call to %s", m.moq.prettyParams_MockableTypes(params))
		}
	}

	if result.doFn != nil {
		result.doFn(onlyExported)
	}
	...
	if result.doReturnFn != nil {
		result1 = result.doReturnFn(onlyExported)
	}
	return
}
...
func (m *moqTypeCache_recorder) LoadPackage(pkgPattern string) *moqTypeCache_LoadPackage_fnRecorder {
	return &moqTypeCache_LoadPackage_fnRecorder{
		params: moqTypeCache_LoadPackage_params{
			pkgPattern: pkgPattern,
		},
...
func (r *moqTypeCache_LoadPackage_fnRecorder) any() *moqTypeCache_LoadPackage_anyParams {
	r.moq.scene.T.Helper()
	if r.results != nil {
		r.moq.scene.T.Fatalf("Any functions must be called before returnResults or doReturnResults calls, recording %s", r.moq.prettyParams_LoadPackage(r.params))
		return nil
	}
	return &moqTypeCache_LoadPackage_anyParams{recorder: r}
}

func (a *moqTypeCache_LoadPackage_anyParams) pkgPattern() *moqTypeCache_LoadPackage_fnRecorder {
	a.recorder.anyParams |= 1 << 0
	return a.recorder
}

func (r *moqTypeCache_LoadPackage_fnRecorder) seq() *moqTypeCache_LoadPackage_fnRecorder {
	r.moq.scene.T.Helper()
	if r.results != nil {
		r.moq.scene.T.Fatalf("seq must be called before returnResults or doReturnResults calls, recording %s", r.moq.prettyParams_LoadPackage(r.params))
		return nil
	}
	r.sequence = true
	return r
...
func (r *moqTypeCache_LoadPackage_fnRecorder) noSeq() *moqTypeCache_LoadPackage_fnRecorder {
	r.moq.scene.T.Helper()
	if r.results != nil {
		r.moq.scene.T.Fatalf("noSeq must be called before returnResults or doReturnResults calls, recording %s", r.moq.prettyParams_LoadPackage(r.params))
		return nil
	}
	r.sequence = false
	return r
...
func (r *moqTypeCache_LoadPackage_fnRecorder) returnResults(result1 error) *moqTypeCache_LoadPackage_fnRecorder {
	r.moq.scene.T.Helper()
	r.findResults()
...
func (r *moqTypeCache_LoadPackage_fnRecorder) andDo(fn moqTypeCache_LoadPackage_doFn) *moqTypeCache_LoadPackage_fnRecorder {
	r.moq.scene.T.Helper()
	if r.results == nil {
...
func (r *moqTypeCache_LoadPackage_fnRecorder) doReturnResults(fn moqTypeCache_LoadPackage_doReturnFn) *moqTypeCache_LoadPackage_fnRecorder {
	r.moq.scene.T.Helper()
	r.findResults()
...
func (r *moqTypeCache_LoadPackage_fnRecorder) findResults() {
	...
	insertAt := -1
	var results *moqTypeCache_LoadPackage_resultsByParams
	for n, res := range r.moq.resultsByParams_LoadPackage {
	...
	if results == nil {
		results = &moqTypeCache_LoadPackage_resultsByParams{
			anyCount:  anyCount,
			anyParams: r.anyParams,
			results:   map[moqTypeCache_LoadPackage_paramsKey]*moqTypeCache_LoadPackage_results{},
		}
		r.moq.resultsByParams_LoadPackage = append(r.moq.resultsByParams_LoadPackage, *results)
		if insertAt != -1 && insertAt+1 < len(r.moq.resultsByParams_LoadPackage) {
			copy(r.moq.resultsByParams_LoadPackage[insertAt+1:], r.moq.resultsByParams_LoadPackage[insertAt:0])
			r.moq.resultsByParams_LoadPackage[insertAt] = *results
		}
	}

	paramsKey := r.moq.paramsKey_LoadPackage(r.params, r.anyParams)

	var ok bool
	r.results, ok = results.results[paramsKey]
	if !ok {
		r.results = &moqTypeCache_LoadPackage_results{
			params:  r.params,
			results: nil,
			index:   0,
			repeat:  &moq.RepeatVal{},
...
func (r *moqTypeCache_LoadPackage_fnRecorder) repeat(repeaters ...moq.Repeater) *moqTypeCache_LoadPackage_fnRecorder {
	r.moq.scene.T.Helper()
	if r.results == nil {
...
func (m *moqTypeCache) prettyParams_LoadPackage(params moqTypeCache_LoadPackage_params) string {
...
func (m *moqTypeCache) paramsKey_LoadPackage(params moqTypeCache_LoadPackage_params, anyParams uint64) moqTypeCache_LoadPackage_paramsKey {
	...
	if anyParams&(1<<0) == 0 {
		if m.runtime.parameterIndexing.LoadPackage.pkgPattern == moq.ParamIndexByValue {
			pkgPatternUsed = params.pkgPattern
		} else {
			pkgPatternUsedHash = hash.DeepHash(params.pkgPattern)
		}
	}
...
func (m *moqTypeCache_recorder) MockableTypes(onlyExported bool) *moqTypeCache_MockableTypes_fnRecorder {
	return &moqTypeCache_MockableTypes_fnRecorder{
		params: moqTypeCache_MockableTypes_params{
			onlyExported: onlyExported,
		},
		sequence: m.moq.config.Sequence == moq.SeqDefaultOn,
...
func (r *moqTypeCache_MockableTypes_fnRecorder) any() *moqTypeCache_MockableTypes_anyParams {
	r.moq.scene.T.Helper()
	if r.results != nil {
		r.moq.scene.T.Fatalf("Any functions must be called before returnResults or doReturnResults calls, recording %s", r.moq.prettyParams_MockableTypes(r.params))
		return nil
	}
	return &moqTypeCache_MockableTypes_anyParams{recorder: r}
}

func (a *moqTypeCache_MockableTypes_anyParams) onlyExported() *moqTypeCache_MockableTypes_fnRecorder {
	a.recorder.anyParams |= 1 << 0
	return a.recorder
}

func (r *moqTypeCache_MockableTypes_fnRecorder) seq() *moqTypeCache_MockableTypes_fnRecorder {
	r.moq.scene.T.Helper()
	if r.results != nil {
		r.moq.scene.T.Fatalf("seq must be called before returnResults or doReturnResults calls, recording %s", r.moq.prettyParams_MockableTypes(r.params))
		return nil
	}
	r.sequence = true
	return r
...
func (r *moqTypeCache_MockableTypes_fnRecorder) noSeq() *moqTypeCache_MockableTypes_fnRecorder {
	r.moq.scene.T.Helper()
	if r.results != nil {
		r.moq.scene.T.Fatalf("noSeq must be called before returnResults or doReturnResults calls, recording %s", r.moq.prettyParams_MockableTypes(r.params))
		return nil
	}
	r.sequence = false
	return r
...
func (r *moqTypeCache_MockableTypes_fnRecorder) returnResults(result1 []dst.Ident) *moqTypeCache_MockableTypes_fnRecorder {
	r.moq.scene.T.Helper()
	r.findResults()
...
func (r *moqTypeCache_MockableTypes_fnRecorder) andDo(fn moqTypeCache_MockableTypes_doFn) *moqTypeCache_MockableTypes_fnRecorder {
	r.moq.scene.T.Helper()
	if r.results == nil {
		r.moq.scene.T.Fatalf("returnResults must be called before calling andDo")
		return nil
...
func (r *moqTypeCache_MockableTypes_fnRecorder) doReturnResults(fn moqTypeCache_MockableTypes_doReturnFn) *moqTypeCache_MockableTypes_fnRecorder {
	r.moq.scene.T.Helper()
	r.findResults()
...
func (r *moqTypeCache_MockableTypes_fnRecorder) findResults() {
	...
	anyCount := bits.OnesCount64(r.anyParams)
	insertAt := -1
	var results *moqTypeCache_MockableTypes_resultsByParams
	for n, res := range r.moq.resultsByParams_MockableTypes {
		if res.anyParams == r.anyParams {
			results = &res
			break
		}
	...
	if results == nil {
		results = &moqTypeCache_MockableTypes_resultsByParams{
			anyCount:  anyCount,
			anyParams: r.anyParams,
			results:   map[moqTypeCache_MockableTypes_paramsKey]*moqTypeCache_MockableTypes_results{},
		}
		r.moq.resultsByParams_MockableTypes = append(r.moq.resultsByParams_MockableTypes, *results)
		if insertAt != -1 && insertAt+1 < len(r.moq.resultsByParams_MockableTypes) {
			copy(r.moq.resultsByParams_MockableTypes[insertAt+1:], r.moq.resultsByParams_MockableTypes[insertAt:0])
			r.moq.resultsByParams_MockableTypes[insertAt] = *results
		}
	}

	paramsKey := r.moq.paramsKey_MockableTypes(r.params, r.anyParams)

	var ok bool
	r.results, ok = results.results[paramsKey]
	if !ok {
		r.results = &moqTypeCache_MockableTypes_results{
			params:  r.params,
			results: nil,
			index:   0,
			repeat:  &moq.RepeatVal{},
...
func (r *moqTypeCache_MockableTypes_fnRecorder) repeat(repeaters ...moq.Repeater) *moqTypeCache_MockableTypes_fnRecorder {
	r.moq.scene.T.Helper()
	if r.results == nil {
		r.moq.scene.T.Fatalf("returnResults or doReturnResults must be called before calling repeat")
		return nil
...
func (m *moqTypeCache) prettyParams_MockableTypes(params moqTypeCache_MockableTypes_params) string {
...
func (m *moqTypeCache) paramsKey_MockableTypes(params moqTypeCache_MockableTypes_params, anyParams uint64) moqTypeCache_MockableTypes_paramsKey {
	...
	if anyParams&(1<<0) == 0 {
		if m.runtime.parameterIndexing.MockableTypes.onlyExported == moq.ParamIndexByValue {
			onlyExportedUsed = params.onlyExported
		} else {
			onlyExportedUsedHash = hash.DeepHash(params.onlyExported)
		}
	}
...
func (m *moqTypeCache) Reset() {
	m.resultsByParams_LoadPackage = nil
	m.resultsByParams_MockableTypes = nil
...
func (m *moqTypeCache) AssertExpectationsMet() {
	m.scene.T.Helper()
	for _, res := range m.resultsByParams_LoadPackage {
		for _, results := range res.results {
			missing := results.repeat.MinTimes - int(atomic.LoadUint32(&results.index))
			if missing > 0 {
				m.scene.T.Errorf("Expected %d additional call(s) to %s", missing, m.prettyParams_LoadPackage(results.params))
			}
		}
	}
	for _, res := range m.resultsByParams_MockableTypes {
		for _, results := range res.results {
			missing := results.repeat.MinTimes - int(atomic.LoadUint32(&results.index))
			if missing > 0 {
				m.scene.T.Errorf("Expected %d additional call(s) to %s", missing, m.prettyParams_MockableTypes(results.params))
			}
		}
	}
