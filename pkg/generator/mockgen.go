...
// TODO: --import should default to current package and --package should default to <current package>_test
//go:generate moqueries --destination mock_converterer_test.go --import github.com/myshkin5/moqueries/pkg/generator --package generator_test Converterer
...
// TODO: --import should default to current package and --package should default to <current package>_test
//go:generate moqueries --destination mock_loadtypesfn_test.go --import github.com/myshkin5/moqueries/pkg/generator --package generator_test LoadTypesFn
